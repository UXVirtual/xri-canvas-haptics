...
1. Make an [Issue](https://github.com/uxvirtual/xri-canvas-haptics/issues/new)
...
```json
    {
        "dependencies": {
            "com.uxvirtual.xri-canvas-haptics": "https://github.com/YOUR_USER/xri-canvas-haptics.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at hello@uxvirtual.com.
